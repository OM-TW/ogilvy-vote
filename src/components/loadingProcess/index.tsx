...
const Background = () => <div className='absolute top-0 h-full w-full bg-[var(--color-yellow)]' />;
...
const LoadingProcess = memo(() => {
  ...
  return (
    <div className='fixed top-0 z-50 flex h-full w-full flex-col items-center justify-center space-y-3 text-[var(--color-purple)]'>
      <Background />
